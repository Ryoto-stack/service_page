    ...
    <section className="py-14 md:py-24 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-4 gap-4  p-5 text-center ">
        <div className="items-center flex flex-col">
          ...
          <h1 className="text-2xl mb-5 font-bold">Responsive</h1>
          <p className="text-balance">I am always available via phone, text, or email.</p>
        </div>
        <div className="items-center flex flex-col">
          <img src="/image-083.jpg" alt="envelope" className="h-[200px]" />
          <h1 className="text-2xl mb-5 font-bold">Syndication</h1>
          <p className="text-balance">I market your property locally, nationally, and internationally</p>
        </div>
        <div className="items-center flex flex-col">
          <img src="/image-085.jpg" alt="envelope" className="h-[200px]" />
          <h1 className="text-2xl mb-5 font-bold">Virtual Tour</h1>
        ...
        <div className="items-center flex flex-col">
          ...
          <h1 className="text-2xl mb-5 font-bold">Photography</h1>
          <p className="text-balance">
